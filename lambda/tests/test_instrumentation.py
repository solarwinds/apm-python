...
"""
Tests that solarwinds-apm/wrapper successfully instruments a mock Lambda
environment with AwsLambdaInstrumentor and OTel Python-based APM distro.
"""
...
def mock_aws_lambda_exec_wrapper():
    ...
    `AWS_LAMBDA_EXEC_WRAPPER` to the `solarwinds-apm/wrapper` script.
    """
    # NOTE: Like opentelemetry-lambda, this tests completion of auto
    # instrumentation without error and if correct environment variables are set.
