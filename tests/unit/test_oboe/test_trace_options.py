...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "trigger-trace",
            TraceOptions(
                trigger_trace=True, timestamp=None, sw_keys=None, custom={}, ignored=[]
            ),
        ),
        (
            "trigger-trace=value",
        ...
        (
            ...
            TraceOptions(
                trigger_trace=None,
                timestamp=None,
                sw_keys="check-id:check-1013,website-id",
                custom={},
        ...
        (
            ...
            TraceOptions(
                trigger_trace=True,
                timestamp=12345,
                sw_keys="029734wr70:9wqj21,0d9j1",
        ...
        (
            ...
            TraceOptions(
                trigger_trace=True,
                timestamp=12345,
                sw_keys="02973r70:1b2a3",
                custom={"custom-something": "value_thing", "custom-key": "val"},
                ignored=[("foo", "bar")],
            ),
        ),
        (
            ...
            TraceOptions(
                ...
                timestamp=None,
                sw_keys=None,
                custom={"custom-foo": "'bar", "custom-bar": "foo"},
                ignored=[("bar'", None)],
            ),
        ),
        (
...
@pytest.mark.parametrize(
    "header, signature, key, timestamp, expected",
    [
        (
