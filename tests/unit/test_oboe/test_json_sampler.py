...
def test_invalid_file_no_samples_created_spans(
    json_sampler_tracer_memory_exporter,
):
    with open(PATH, "w") as f:
...
def test_missing_file_no_samples_created_spans(
    json_sampler_tracer_memory_exporter,
):
...
def test_expired_file_no_samples_created_spans(
    json_sampler_tracer_memory_exporter,
):
    with open(PATH, "w") as f:
        json.dump(
...
def test_samples_after_reading_new_settings(
    json_sampler_tracer_memory_exporter,
):
    with open(PATH, "w") as f:
        json.dump(
