...
class TestW3CTransformer:
    def test_span_from_int(self):
        assert W3CTransformer.span_id_from_int(1111222233334444) == "{:016x}".format(
            1111222233334444
        )
    ...
    def test_traceparent_from_context(self, span_context):
        assert W3CTransformer.traceparent_from_context(
            span_context
    ...
    def test_sw_from_context(self, span_context):
        assert W3CTransformer.sw_from_context(span_context) == "{:016x}-{:02x}".format(
