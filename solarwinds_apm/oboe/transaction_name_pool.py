...
class TransactionNamePool:
    def __init__(self, max_size: int = TRANSACTION_NAME_POOL_MAX, ttl: int = TRANSACTION_NAME_POOL_TTL, max_length: int = TRANSACTION_NAME_MAX_LENGTH, default: str = TRANSACTION_NAME_DEFAULT):
