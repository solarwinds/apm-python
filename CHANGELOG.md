...
### Changed
- SolarWinds c-lib 11.2.0, for gRPC upgrade ([#89](https://github.com/appoptics/solarwinds-apm-python/pull/89))
...
### Removed
- Drop CentOS 7 and glibc < 2.27 support ([#89](https://github.com/appoptics/solarwinds-apm-python/pull/89))
